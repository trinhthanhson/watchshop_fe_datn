...
const PieChartInventory = () => {
    ...
    async function fetchMostSoldProducts() {
      try {
        ...
        const response = await axios.get(
          'http://localhost:9999/api/staff/inventory/statistic/product',
          {
            headers: {
  ...
  return (
    <div className="bg-white p-4 rounded-md border border-gray-200 flex flex-col flex-[0.45]">
      <strong className="text-sub font-semibold">Sản phẩm dự kiến nhập</strong>
...
export default PieChartInventory
