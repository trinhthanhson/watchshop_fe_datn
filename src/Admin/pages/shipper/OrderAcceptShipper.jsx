...
import { getAllOrderShipperRequest } from '../../../redux/actions/shipper/action'

const OrderAcceptShipper = () => {
  const dispatch = useDispatch()
  const orders = useSelector((state) => state.order_shipper?.order_shipper)
  ...
  useEffect(() => {
    dispatch(getAllOrderShipperRequest(currentPage, recordsPerPage))
